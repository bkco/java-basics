package co.bk.javabasics.patterns.factory.abstractfactory;
 ...
 * <p>
 * Advantages:
 * 1. It isolates the concrete classes that are generated.  The names of actual implementing classes are 
 *    not needed to be known at the client side. Because of the isolation, you can change the 
 *    implementation from one factory to another.
 * 
 * Reasons for using:
 * 1. You may often don't just want to create a single object (as with Factory method),
 *    rather you want to create a collection of related objects.
 * 
