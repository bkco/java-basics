...
// * 		11G --> javap -classpath sdoutl-11.2.0.jar oracle.spatial.util.ShapefileReaderJGeom
// * 		10G --> javap -classpath sdoutl-1.0.jar oracle.spatial.util.ShapefileReaderJGeom
